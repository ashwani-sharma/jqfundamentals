...
List.prototype.sortingByPriorityDescending = function () {
  this.list_items.sortListItemsByPriorityDescending();
}
...
List.prototype.sortingbyAlphabetDescending = function () {
  this.list_items.sortListItemsByAlphabetDescending();
}
...
List.prototype.createLinks = function (className, textNode) {
  this.list_items.createLink(className, textNode);
}